...
public class FriendRequestController {
    ...
    @PostMapping
    public Message friendRequestUser(@RequestParam(name = "userA", required = true) String userA, @RequestParam(name = "userB", required = true) String userB) {
        return friendRequestService.friendRequestUser(userA, userB);
    }

    @PostMapping("/accept")
    public Message acceptFriendRequest(@RequestBody FriendRequest friendRequest) {
        return friendRequestService.acceptFriendRequest(friendRequest);
    }

    @PostMapping("/decline")
    public Message declineFriendRequest(@RequestBody FriendRequest friendRequest) {
